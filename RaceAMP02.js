define(['pipAPI', 'https://brattcze.github.io/MainAMPScript.js'], function (APIConstructor, ampExtension) {
    ...
    var obj = {
        ...
        trialsInExample : [0],//Changeto 0 if you don't want an example block
    };
